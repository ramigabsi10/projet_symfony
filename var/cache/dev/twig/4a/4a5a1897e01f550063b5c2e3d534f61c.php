...
class __TwigTemplate_56afdfa6207f732d6e05973e79ef009e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <br/>
    <button class=\"form-control btn btn-primary\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "provider/_form.html.twig", "D:\\docker\\symfony_Demo_Docker-master\\templates\\provider\\_form.html.twig");
    }
}
